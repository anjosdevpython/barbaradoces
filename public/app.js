...
const FALLBACK_DATA = {
    ...
    products: [
        ...
        { id: '3', name: "Bombom de uva no pote", price: 10.00, category: 'Bombons', image: "./public/assets/products/bombom-uva-final.png" },
        { id: '4', name: "Banoffe", price: 10.00, category: 'Sobremesas', image: "./public/assets/products/banoffe-final.png" },
        { id: '5', name: "Pavê de morango", price: 10.00, category: 'Sobremesas', image: "./public/assets/products/pave-morango-final.png" },
        { id: '6', name: "Pavê de ninho com Nutella", price: 10.00, category: 'Sobremesas', image: "./public/assets/products/pave-ninho-nutella-final.png" },
        { id: '7', name: "Mousse de maracujá", price: 10.00, category: 'Sobremesas', image: "./public/assets/products/mousse-maracuja-real.jpeg" },
        { id: '8', name: "Palha Italiana Tradicional", price: 7.50, category: 'Palhas', image: "./public/assets/products/palha-tradicional-final.png" },
        { id: '9', name: "Palha de Oreo", price: 7.50, category: 'Palhas', image: "./public/assets/products/palha-oreo-final.png" },
        { id: '10', name: "Palha de Paçoca", price: 7.50, category: 'Palhas', image: "./public/assets/products/palha-pacoca-final.png" },
        { id: '11', name: "Cone trufado de maracujá", price: 6.50, category: 'Cones', image: "./public/assets/products/cone-maracuja-final.png" },
        { id: '12', name: "Cone trufado de limão", price: 6.50, category: 'Cones', image: "./public/assets/products/cone-limao-final.png" },
        { id: '13', name: "Cone trufado de ninho", price: 6.50, category: 'Cones', image: "./public/assets/products/cone-ninho-final.png" },
        { id: '14', name: "Cone trufado de nozes", price: 6.50, category: 'Cones', image: "./public/assets/products/cone-nozes-final.png" },
        { id: '15', name: "Cone trufado de pistache", price: 6.50, category: 'Cones', image: "./public/assets/products/cone-pistache-final.png" },
        { id: '16', name: "Travessa de Banoffe (≈ 1,1kg)", price: 55.00, category: 'Travessas', image: "./public/assets/products/travessa-banoffe-final.png" }
    ]
};
